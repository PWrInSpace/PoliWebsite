...
export default function YouTubeIcon(props: IconProps) {
    ...
    return (
        <svg width={width} height={height} viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => window.location.href = 'https://www.youtube.com/@poliwrocket1294'}>
